...
namespace planeta_engine {
	namespace core {
		...
		bool EmptySceneDefinition::SetUpScene(SceneAccessorForSetUp& scene, const utility::ParameterHolder& initialize_parameters) {
			auto ip = scene.CreateGameProcess<game_processes::InstantProcess>(std::string(gameprocess_sys_key_pos::GameObjectUpdatetProcessKeyPositionID),InsertPosIndication::At);
