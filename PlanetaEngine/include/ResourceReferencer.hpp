...
namespace plnt {
	...
	namespace private_ {
		...
		public:
			ResourceManagerInternalAccessor(const std::function<std::shared_ptr<ResourceBase>(const std::type_info&, const std::string&, bool)>& ref_func_by_id, const std::function<std::shared_ptr<ResourceBase>(const std::type_info&, const std::string&, const std::string&, bool)>& ref_func_by_path);
		...
		private:
			std::function<std::shared_ptr<ResourceBase>(const std::type_info& type, const std::string&, bool)> ref_func_by_id_;
			std::function<std::shared_ptr<ResourceBase>(const std::type_info& type, const std::string&, const std::string&, bool)> ref_func_by_path_;
		};
	}
	class ResourceReferencer {
	public:
		ResourceReferencer(private_::ResourceManagerInternalAccessor& res_mgr_acsr, const std::string& root_path, std::vector<std::shared_ptr<ResourceBase>>& reference_list);
		...
		std::shared_ptr<ResourceBase> ReferenceResourceByTypeAndPath(const std::type_info& type, const std::string& path);
		template<class RT>
		...
		std::shared_ptr<ResourceBase> ReferenceResourceByTypeAndIDorPath(const std::type_info& type, const std::string& id_or_path);
		template<class RT>
