...
namespace plnt {
	namespace util {
		...
		private:
			...
			template<class Archive>
			friend void boost::serialization::save(Archive& ar, const plnt::util::DataContainer& datacontainer, unsigned int);
			template<class Archive>
			friend void boost::serialization::load(Archive& ar, plnt::util::DataContainer& data_container, unsigned int);
		};
	}
}
