	...
	namespace file_system {
		namespace {
			...
			constexpr access_mode::type ConvertAccessModeToUint32(AccessMode mode) {
				return mode == planeta_engine::file_system::AccessMode::ReadOnly ? access_mode::Read :
					mode == planeta_engine::file_system::AccessMode::WriteOnly ? access_mode::Write :
					mode == planeta_engine::file_system::AccessMode::ReadWrite ? access_mode::ReadWrite :
					mode == planeta_engine::file_system::AccessMode::Invalid ? access_mode::None : access_mode::None;
			}
