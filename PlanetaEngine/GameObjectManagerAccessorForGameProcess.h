...
namespace planeta_engine {
	namespace game {
		class GameObjectManagerAccessorForGameProcess final{
		public:
			explicit GameObjectManagerAccessorForGameProcess(GameObjectManagerPublicInterface& gopi) :game_object_manager_public_interface_(gopi) {};
			/*ゲームオブジェクトを作成*/
