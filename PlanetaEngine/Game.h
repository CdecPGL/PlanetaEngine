...
namespace planeta_engine {
	namespace core {
		...
		private:
			...
			std::shared_ptr<core::GameProcessKeyPositionDefinition> game_process_key_position_definition_;
			...
			core::GameProcessKeyPositionDefinition& RefGameProcessKeyPositionDefinition()override { return *game_process_key_position_definition_; }

			std::shared_ptr<const core::CollisionGroupMatrix> GetCollisionGroupMatrix()const override { return collision_group_matrix_; }
			const std::list<std::string>& GetGameProcessKeyPositionList()const override;
		};
	}
}
