...
namespace planeta_engine {
	namespace core {
		...
		public:
			explicit SceneAccessorForGameProcess(ScenePublicInterface& spi) :game_object_manager_accessor_(spi.game_object_manager()),game_process_manager_accessor_(spi.game_process_manager()),gui_manager_accessor_(spi.gui_manager()),camera_(spi.camera()) {}
