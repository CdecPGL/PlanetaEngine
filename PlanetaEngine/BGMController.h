...
namespace planeta_engine{
	...
	namespace core {
		...
		public:
			BGMController(const std::shared_ptr<resources::MusicResource>& mr) :music_resource_(mr) {}
			~BGMController();
			...
			void Update();
			void Dispose();
			const std::shared_ptr<resources::MusicResource> resource()const { return music_resource_; }
		private:
			std::shared_ptr<resources::MusicResource> music_resource_;
