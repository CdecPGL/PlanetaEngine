...
namespace plnt {
	...
	private:
		double get_altitude_with_ground_position(const vector_2dd &ground_pos) const override { return -1; }
		...
		vector_2dd normalize_ground_vector_with_ground_position(const vector_2dd &ground_pos,
		                                                  const vector_2dd &ground_vector) const override {
			return ground_vector;
		}

		double get_angle_difference_in_rad_ground_from_global_with_ground_position(const vector_2dd &ground_pos) const override {
			return 0;
		}
	};
