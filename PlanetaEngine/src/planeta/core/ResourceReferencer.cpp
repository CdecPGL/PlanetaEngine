#include "planeta/core/ResourceReferencer.hpp"
...
namespace plnt {
	...
	std::shared_ptr<ResourceBase> ResourceReferencer::ReferenceResourceByTypeAndID(const std::type_info& type, const std::string& id) {
	...
	std::shared_ptr<ResourceBase> ResourceReferencer::ReferenceResourceByTypeAndPath(const std::type_info& type, const std::string& path) {
	...
	std::shared_ptr<ResourceBase> ResourceReferencer::ReferenceResourceByTypeAndIDorPath(const std::type_info& type, const std::string& id_or_path) {
