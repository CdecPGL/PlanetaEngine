...
namespace planeta_engine{
	namespace utility{
		...
		public:
			...
			void do_all(T(C_obj::*)());
			template<typename T>
			void do_all(T(C_obj::*)()const)const;
		...
		template <class C_obj>
		template<typename T>
		void ObjectHolderTemplate_WithoutID<C_obj>::do_all(T(C_obj::* func)()){
		...
		template <class C_obj>
		template<typename T>
		void ObjectHolderTemplate_WithoutID<C_obj>::do_all(T(C_obj::* func)()const)const{
