...
namespace planeta_engine {
	...
	namespace scene_accessor_impl {
		...
		public: 
			...
			/*ゲームオブジェクトを名前を付けて作成*/
			utility::WeakPointer<game::IGameObjectAccessor> CreateGameObjectWithName(const std::string& game_object_create_id, const std::string& name);
			/*ゲームオブジェクトを作成して有効化*/
			...
			utility::WeakPointer<game::IGameObjectAccessor> CreateAndActivateGameObjectWithName(const std::string& game_object_create_id, const std::string& name);
		private:
