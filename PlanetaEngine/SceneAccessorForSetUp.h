...
namespace planeta_engine {
	namespace core {
		...
		public:
			explicit SceneAccessorForSetUp(ScenePublicInterface& spi) :game_object_manager_accessor_(spi.game_object_manager()), game_process_manager_accessor_(spi.game_process_manager()), ui_manager_accessor_(spi.gui_manager()) {}
			game::GameObjectManagerAccessorForSetUp& game_object_manager() { return game_object_manager_accessor_; }
			game::GUIManagerAccessorForSetUp& ui_manager() { return ui_manager_accessor_; }
		...
		private:
			...
			game::GUIManagerAccessorForSetUp ui_manager_accessor_;
