...
namespace planeta_engine {
	...
	namespace components {
		...
		public:
			...
			const Vector2D<double>& graph_center()const { return graph_center_; }
			void graph_center(const Vector2D<double>& pos) { graph_center_ = pos; }
		private:
			/*反転描画フラグ*/
			bool reverse_ = false;
			/*画像上で表示する範囲*/
			...
			/*画像の中心位置*/
			Vector2D<double> graph_center_ = Vector2D<double>(0.5, 0.5);
			/*画像描画データ*/
