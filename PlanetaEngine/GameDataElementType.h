...
namespace planeta_engine {
	namespace core {
		...
		public:
			...
			static void ResistComplexType(const std::string& type_id,std::unique_ptr<GameDataComplexType>&& complex_type)noexcept;
			...
			static bool ComplexTypeElementTypeCheck()noexcept;
		private:
			static boost::bimaps::bimap<boost::bimaps::unordered_set_of<Type>, boost::bimaps::unordered_set_of<std::string>> type_tid_map_;
			static std::unordered_map<std::string, std::unique_ptr<GameDataComplexType>> complex_type_map_;
		};
	}
}
