...
namespace planeta_engine {
	namespace game {
		class GameObjectManagerAccessorForGameObject final {
		public:
			explicit GameObjectManagerAccessorForGameObject(GameObjectManagerPublicInterface& gopi) :game_object_manager_public_interface_(gopi) {};
			/*ゲームオブジェクトを作成*/
