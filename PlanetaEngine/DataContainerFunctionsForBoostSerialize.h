...
namespace boost {
	namespace serialization {
		...
		void serialize(Archive& ar, planeta_engine::utility::DataContainer& data_container, unsigned int version) {
			split_free(ar, data_container, version);
		}
		template<class Archive>
		void save(Archive& ar, const planeta_engine::utility::DataContainer& data_container, unsigned int) {
